        ...
        VStack(spacing: 20) {
            ...
            VStack(spacing: 12) {
                ...
                Text(enableSmartPaste ? 
                     "SpeedyWhisper needs permissions to work properly:" :
                     "SpeedyWhisper needs microphone access to record audio:")
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            VStack(spacing: 12) {
                ...
                Text("SpeedyWhisper needs microphone and accessibility permissions to work properly.")
                    .multilineTextAlignment(.center)
                    .foregroundStyle(.secondary)
                ...
                VStack(spacing: 8) {
                    ...
                    HStack {
                        Text("2.")
                            .fontWeight(.semibold)
                        Text("Enable SpeedyWhisper in 'Microphone' section")
                    }
                    
                    HStack {
                        Text("3.")
                            .fontWeight(.semibold)
                        Text("Enable SpeedyWhisper in 'Accessibility' section")
                    }
                }
                .font(.callout)
                .foregroundStyle(.primary)
