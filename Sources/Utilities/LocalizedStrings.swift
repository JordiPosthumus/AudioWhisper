...
/// Centralized localized strings for SpeedyWhisper
internal enum LocalizedStrings {
    ...
    enum Alerts {
        ...
        static let microphoneAccessMessage = NSLocalizedString("alerts.microphone_access_message", 
            value: "SpeedyWhisper needs microphone access to record audio. Please enable microphone access in System Settings > Privacy & Security > Microphone.",
